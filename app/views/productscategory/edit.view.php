        ...
        <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="row dr_arabic">
                <div class="form-group col-md-12 flex-column"> <!-- category name -->
                    <label for="category_name" <?= $this->floatlabel('category_name' , $productcategory) ?> ><?= isset($Text_label_category_name) ? $Text_label_category_name : '' ?></label>
                    <input type="text" class="form-control box" id="category_name" required name="category_name"
                           maxlength="30"
                           value="<?= $this->showvalue('category_name' , $productcategory) ?>">
