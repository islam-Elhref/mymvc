        ...
        <form method="post" enctype="application/x-www-form-urlencoded" id="purchases_form" class="needs-validation"
            ...
            <div class="row dr_arabic">
                    ...
                    <select name="bill_id" id="bill_id" class="custom-select" required>
                        ...
                        if (isset($purchases) && !empty($purchases)) {
                            foreach ($purchases as $purchase) {
                                ?>
                                <option <?= $this->selectedoptions('bill_id', $purchase->getbill_id()) ?>
                                        value="<?= $purchase->getbill_id() ?>"> <?= $purchase->getbill_id() . ' :-- ' . $purchase->getsuppliername() ?>  </option>
                                <?php
                            }
                        }
                        ?>
                ...
                <div class="form-group flex-column col-md-2"> <!-- reciept_type -->
                    ...
                    <select name="reciept_type" id="reciept_type" class="custom-select" required>
